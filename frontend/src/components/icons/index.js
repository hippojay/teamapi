...
export const JiraIcon = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M2.571 3.214a2.57 2.57 0 1 0 0-5.143 2.57 2.57 0 0 0 0 5.143Zm9.714 1.6c-.797-.283-1.454-.881-1.796-1.636L9.973 1.1 6.752 8.7l2.897 4.673-.787 1.127a2.57 2.57 0 1 0 4.796 1.88 2.57 2.57 0 0 0-1.593-2.757l.793-1.137-2.29-3.688L12.795 3.6c.798.283 1.454.881 1.796 1.636l2.738 7.708-2.729 1.25-2.738-7.708a2.58 2.58 0 0 0-2.457-1.798H2.288a2.57 2.57 0 1 0 0 5.142h2.172l3.097-8.964A2.577 2.577 0 0 0 9.166.8a2.58 2.58 0 0 0 2.458 1.798h2.738z"/>
  </svg>
);
